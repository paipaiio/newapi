...
// Legacy task action constants — fork code references these directly.
// Upstream uses NormalizeTaskAction to map them at runtime; the fork expects them as constants.
const (
...
// Suno action constants (fork extension for relay/channel/task/suno)
const (
