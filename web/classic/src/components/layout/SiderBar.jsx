...
const routerMap = {
  ...
  'api-sale': '/console/api-sale',
  'group-exclusive': '/console/group-exclusive',
  'channel-cost': '/console/channel-cost',
  'token-lookup': '/console/token-lookup',
  'alert-setting': '/console/alert-setting',
