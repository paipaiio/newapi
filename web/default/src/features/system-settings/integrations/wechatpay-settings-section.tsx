      ...
      {values.WechatPayEnabled && (
        <>
          <div className='grid grid-cols-2 gap-4'>
            <div className='space-y-1.5'>
              ...
              <Input
                ...
                onChange={(e) => onValueChange('WechatPayMchId', e.target.value)}
              />
            ...
            <div className='space-y-1.5'>
              ...
              <Input
                ...
                onChange={(e) => onValueChange('WechatPayAppId', e.target.value)}
              />
              <p className='text-muted-foreground text-xs'>
          ...
          <div className='space-y-1.5'>
            ...
            <Input
              placeholder={showApiV3Key ? 'Your 32-char APIv3 key' : values.WechatPayApiV3Key ? '••••••••' : ''}
              type={showApiV3Key ? 'text' : 'password'}
              value={showApiV3Key ? values.WechatPayApiV3Key : values.WechatPayApiV3Key ? '••••••••' : ''}
              onChange={(e) => onValueChange('WechatPayApiV3Key', e.target.value)}
          ...
          <div className='space-y-1.5'>
            ...
            <Input
              ...
              onChange={(e) => onValueChange('WechatPaySerialNo', e.target.value)}
          ...
          <div className='space-y-1.5'>
            ...
            <Textarea
              ...
              onChange={(e) => onValueChange('WechatPayPrivateKey', e.target.value)}
          ...
          <div className='space-y-1.5'>
            ...
            <Input
              ...
              onChange={(e) => onValueChange('WechatPayNotifyUrl', e.target.value)}
            />
            <p className='text-muted-foreground text-xs'>
          ...
          <div className='grid grid-cols-2 gap-4'>
            <div className='space-y-1.5'>
              ...
              <Input
                ...
                onChange={(e) =>
                  onValueChange('WechatPayUnitPrice', parseFloat(e.target.value) || 0)
                }
              />
              <p className='text-muted-foreground text-xs'>
            ...
            <div className='space-y-1.5'>
              ...
              <Input
                ...
                onChange={(e) =>
                  onValueChange('WechatPayMinTopUp', parseFloat(e.target.value) || 0)
                }
              />
            </div>
          </div>
