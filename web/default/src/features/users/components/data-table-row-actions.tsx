  ...
  return (
    <div className="-ml-1.5 flex items-center gap-1">
      ...
      >
        ...
        {user.login_disabled ? (
          <DropdownMenuItem onClick={() => handleManage("enable_login")}>
            {t("Enable console login")}
            <DropdownMenuShortcut>
              <LogIn size={16} />
            </DropdownMenuShortcut>
          </DropdownMenuItem>
          ...
          <DropdownMenuItem
            onClick={() => handleManage("disable_login")}
            disabled={isRoot}
          >
            {t("Disable console login")}
            <DropdownMenuShortcut>
              <LogIn size={16} />
            </DropdownMenuShortcut>
          </DropdownMenuItem>
        ...
        {user.allow_topup === false ? (
          <DropdownMenuItem onClick={() => handleManage("allow_topup")}>
            {t("Allow top-up")}
            <DropdownMenuShortcut>
              <Wallet size={16} />
            </DropdownMenuShortcut>
          ...
          <DropdownMenuItem onClick={() => handleManage("disallow_topup")}>
            {t("Disallow top-up")}
            <DropdownMenuShortcut>
              <Wallet size={16} />
            </DropdownMenuShortcut>
