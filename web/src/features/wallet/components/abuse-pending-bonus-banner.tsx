...
export function AbusePendingBonusBanner({
  ...
  // pendingBonus 是内部额度单位，formatQuota 按站点配置的展示币种（默认美元）换算。
  const bonusDisplay = formatQuota(pendingBonus)

  return (
    <div className='mb-3 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-950/30'>
