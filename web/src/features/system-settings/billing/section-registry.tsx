...
const getGroupDefaults = (settings: BillingSettings) => ({
  ...
  UserGroupDefaultGroup:
    settings['group_ratio_setting.user_group_default_group'],
})
    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          AlipayUnitPrice: settings.AlipayUnitPrice ?? 7.0,
          AlipayMinTopUp: settings.AlipayMinTopUp ?? 1.0,
          ...
          WechatPayUnitPrice: settings.WechatPayUnitPrice ?? 7.0,
          WechatPayMinTopUp: settings.WechatPayMinTopUp ?? 1.0,
        }}
        waffoDefaultValues={{
