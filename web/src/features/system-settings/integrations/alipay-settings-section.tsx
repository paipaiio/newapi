      ...
      {values.AlipayEnabled && (
        <>
          ...
          <div className='space-y-1.5'>
            ...
            <p className='text-muted-foreground text-xs'>
              {t(
                'Your application private key (RSA2). Leave blank to keep existing.'
              )}
            </p>
          </div>
          ...
          <div className='space-y-1.5'>
            ...
            <Textarea
              ...
              onChange={(e) => onValueChange('AlipayPublicKey', e.target.value)}
            ...
            <p className='text-muted-foreground text-xs'>
              {t(
                'Alipay public key for signature verification. Leave blank to keep existing.'
              )}
            </p>
          </div>
