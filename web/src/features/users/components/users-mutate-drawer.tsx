              ...
              {isUpdate && (
                <SideDrawerSection>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('Recharge discount')}</FormLabel>
                        <FormControl>
                          <Input
                            type='number'
                            min={0}
                        ...
                        <FormDescription className='text-xs'>
                          {t(
                            'Per-user discount rate (0-1, 1 = no discount). Combined with the global discount, the lower rate applies.'
                          )}
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <MultiSelect
                            ...
                            placeholder={t(
                              'All groups visible (no restriction)'
                            )}
                          />
                        </FormControl>
                        <FormDescription className='text-xs'>
                          {t(
                            'Display-only whitelist. When set, the user only sees these groups in dropdowns / model market / pricing. Empty = all available groups.'
                          )}
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
