...
export function useUsersColumns(
  ...
  return useMemo<ColumnDef<User>[]>(
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const abuseFlagged = row.original.invite_abuse_flagged
          const abuseReason = row.original.invite_abuse_reason
    ...
    [t, quotaUnit, currencyConfig, expandedUserId, onToggleExpand]
  )
}
