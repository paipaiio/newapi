...
export function ApiKeysMutateDrawer({
  ...
  const {
    ...
    queryKey: ['api-key', adminUserId, currentRowId],
    queryFn: () =>
      isAdmin && adminUserId != null
        ? adminGetUserTokenDetail(adminUserId, currentRowId ?? 0)
        ...
        <Form {...form}>
          ...
          >
            <SideDrawerSection>
              ...
              {selectedGroup !== 'auto' && groups.length > 1 && (
                <FormField
                  control={form.control}
                  name='extra_groups'
                  render={({ field }) => (
                      ...
                      <FormControl>
                        <MultiSelect
                          options={groups
                            .filter(
                              (g) =>
                                g.value !== 'auto' && g.value !== selectedGroup
                            )
                          ...
                          placeholder={t('Bind additional groups (optional)')}
                        />
                      </FormControl>
                      <FormDescription className='text-xs'>
                        {t(
                          'The token routes across the primary group and these additional groups in order.'
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription className='text-xs'>
                        {t('Requests per minute, 0 = unlimited')}
                      </FormDescription>
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription className='text-xs'>
                        {t('Tokens per minute, 0 = unlimited')}
                      </FormDescription>
                    </FormItem>
                  )}
                />
