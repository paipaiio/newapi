...
func TestStripeWebhookEnabledRequiresDynamicTopUpAndWebhookConfig(t *testing.T) {
	...
	// Stripe Checkout uses inline price_data, so a pre-created price ID is optional.
