# TUFTech Electron Desktop App

This directory contains the Electron wrapper for TUFTech, providing a native desktop application with system tray support for Windows, macOS, and Linux.
